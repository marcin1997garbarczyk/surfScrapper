"""
Django settings for coreDjangoApp project.
...
SECRET_KEY = 'django-insecure-(cxsz5q#hdh0=uk^-=hzzzi01qhijz03f#%e&v3zb&eou%s9f5'
...
WSGI_APPLICATION = 'coreDjangoApp.wsgi.application'
